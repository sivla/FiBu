...
Auf der Debitorenseite gilt dieselbe Logik, aber mit einem anderen Sammelkonto. Eine Debitorenbuchungsgruppe darf erst angelegt werden, wenn das Forderungskonto sichtbar im Kontenplan vorhanden ist. Das Konto **1406 Abziehbare Vorsteuer 19 Prozent** ist dafuer nicht geeignet, weil es zur Vorsteuer gehoert. Fuer die SKR04-orientierte Universaarl-Struktur ist **1200 Forderungen aus Lieferungen und Leistungen** der richtige naechste Sammelkonto-Kandidat. Solange dieses Konto nicht sichtbar als Bilanzkonto mit Kontoart **Buchung** und passender Bezeichnung bestaetigt ist, bleibt die Debitorenbuchungsgruppe gesperrt.
