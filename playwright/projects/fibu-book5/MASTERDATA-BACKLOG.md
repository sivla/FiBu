...
| Anlage | 7, 21 | `FA-CNC-01` | nur geplant; `FIXEDASSETS-001` hat erste Tell-Me-Einstiege read-only geprueft; `FIXEDASSETS-002` hat deutsche Suchbegriffe und den Zielbetrag `120.000 EUR` harmonisiert; `FIXEDASSETS-003` oeffnet Anlagenliste, AfA-Buecher, Einkaufsrechnungen und Anlagenposten direkt als labor-candidate, aber FA Posting Groups ueber Page-ID `5606` ist rejected | ja, jetzt `120000` | ja, `fixedassets-001`, `fixedassets-002`, `fixedassets-003` | `planned-only / readiness` | P2 | `FIXEDASSETS-004`: UI-first Setup-Readiness fuer `FA-CNC-01`, `HGB`, alternativen FA-Posting-Groups-Pfad und Zugangspfad planen; noch kein Setup und keine Buchung. |
