...
| Dimensionen | passt | `PRODUCTLINE`, `CHANNEL`, `LOCATION-GROUP`, `DEPARTMENT` und Werte angelegt; Standarddimensionen gesetzt; `PRODUCTLINE=MACHINE` nach O2C-Buchung am Artikelposten nachgewiesen | `masterdata-002`, `masterdata-003`, `masterdata-007`, `UAT-O2C-001` | `PRODUCTLINE=MACHINE` am Artikel, `CHANNEL=B2B` am Debitor und beide Dimensionen am Artikelposten `Entry No. 792` nachgewiesen | gleiche Dimensionen und globale/Shortcut-Dimensionen in DE-Company pruefen | Dimensionswirkung in Reporting/Financial Reports auswerten |
