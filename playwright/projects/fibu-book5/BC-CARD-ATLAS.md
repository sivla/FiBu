...
| No. Series / Nummernserien | `456` | Foundation/Numbering | Seriencode, Beschreibung, Start-/Endnummernspalten, Checkboxen wie `Standardnr.`, `Manuelle Anz.` und `Luecken in Nummern zulassen` | `Zeilen`, `Liste bearbeiten`, Page-Inspection-Shortcut `Ctrl+Alt+F1`; Checkbox-Klicks nur mit gesicherter Zeilenbindung; D2C soll Karte/Details, Personalisieren oder Page Inspection read-only pruefen | `evidence/target-016*/`; TARGET-016 zeigt U-Serienkoepfe, TARGET-016D beweist Lines-Page/Table/Felder; TARGET-036D2 zeigt `U-VEND` mit sichtbaren Checkbox-Spalten; TARGET-036D2B zeigt, dass auch die markierte DOM-Checkboxroute nicht eindeutig genug ist | TARGET-036D2: Der sichtbare row-scoped Klick auf `Standardnr.` fuer `U-VEND` persistiert nicht. TARGET-036D2B: die sichtbare U-VEND-Zeile bleibt da, aber der Locator kann `Standardnr.` nicht eindeutig an diese Zeile binden. Nicht wiederholen ohne neue Karten-/Personalisierungs-/Inspection-Route. Keine Stammdaten-/Belegnummernreife. |
