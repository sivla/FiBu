...
| Manufacturing | Manufacturing | `labor-sufficient-for-book-draft` | `L1`, `L8`, `L9` | Production BOMs, Routings, Work Centers, Released Production Orders | `evidence/manufacturing-001/` bis `evidence/manufacturing-004/`, `book-drafts/manufacturing-labor-draft.md` | `img/manufacturing-003-*` | Kapitel 14 | direkte Seitenkontexte belegt; kein Production BOM/Routing fuer `RM-M100`, kein Fertigungsauftrag, kein Verbrauch, kein Output, keine Postenspur | ja | `MANUFACTURING-005` Kapitel-14-Labor-vs-Zielpfad bereinigen |
