...
| Dimensionen | 7, 10, 25 | `PRODUCTLINE`, `CHANNEL`, `DEPARTMENT`, `LOCATION-GROUP`, spaeter `COMPANY-GROUP`/`PROJECT` | Kernwerte angelegt; `DEPARTMENT` wiederverwendet | ja, `masterdata/dimensions.json` | ja, `masterdata-002/003/007`, O2C | `partial` | P0 | Weitere Werte erst pro Prozess anlegen; Reportingwirkung pruefen. |
| Dimensionswerte Kern | 7, 10, 11 | `MACHINE`, `B2B`, `SALES`, `DIRECTED` | in `RM-DEMO` nachgewiesen | ja | ja | `done-labor` | P0 | Keine Sofortaktion. |
| Dimensionswerte Erweiterung | 7, 10, 12-18 | `SPARE`, `SERVICE`, `PROJECT`, `RENTAL`, `SHOP`, `IC`, `SIMPLE`, `VAN`, `DROP` | geplant, nicht vollstaendig belegt | ja | nein | `planned-only` | P1-P3 | Beim ersten Prozessbedarf idempotent anlegen und fotografieren. |
