...
Im Kontenplan sieht man bei jedem Sachkonto die Nummer, den Namen, `GuV/Bilanz` und die Kontoart. `1800 Bank Saarland` steht als Bilanzkonto fuer spaetere Bank- und Zahlungsprozesse. `1406 Abziehbare Vorsteuer 19 Prozent` steht ebenfalls als Bilanzkonto und wird spaeter fuer die Einkaufs-USt gebraucht. `3300 Verbindlichkeiten aus Lieferungen und Leistungen` ist das spaetere Sammelkonto fuer Kreditoren. `3806 Umsatzsteuer 19 Prozent` ist das spaetere Umsatzsteuerkonto fuer Verkaufsprozesse. Diese Konten allein buchen aber noch keine Vorsteuer, Umsatzsteuer oder Kreditorenposten. Erst wenn Buchungsgruppen, Buchungsmatrix und VAT Posting Setup zusammenpassen, kann Business Central beim Einkauf oder Verkauf automatisch die richtigen Sach- und Steuerposten erzeugen.
