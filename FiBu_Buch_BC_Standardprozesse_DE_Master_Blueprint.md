...
|---|---|---|---|
| Anlage | `FA-CNC-01` | `FIXEDASSETS-032` zeigt: Der Code existiert in `RM-DEMO`; auf der geoeffneten Karte sind `HGB`, `MACHINES`, `Book Value = 0,00`, AfA-Start `01.01.2026`, Nutzungsdauer `8,00` und AfA-Ende `31.12.2033` sichtbar. Beschreibung, Klasse und Unterklasse sind aber weiter leer beziehungsweise nicht editierbar belegt | Nicht als fertige Anlage verwenden. Vor Kreditor, Einkaufsrechnung, Zugang oder AfA muss die vorhandene Karte vollstaendig mit Beschreibung, Klasse/Unterklasse und Setupwerten sichtbar tragen |
