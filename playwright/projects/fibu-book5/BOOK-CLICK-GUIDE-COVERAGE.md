...
| Inventory Posting Setup | Blockierende Lagerbuchungsmatrix-Zeile `FRA-ZL` + `RESALE` untersuchen | `MASTERDATA-008` | `playwright/projects/fibu-book5/img/masterdata-008-inventory-posting-setup-fra-zl-resale.png` | `evidence/masterdata-008/013-diagnosis.json`, `evidence/masterdata-008/014-learning-note.md` | praktisch nachgewiesen als Labor-Diagnose; Zielzeile ist sichtbar, `Inventory Account` ist leer, keine Kontenentscheidung getroffen |
