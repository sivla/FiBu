...
| General Posting Setup / Buchungsmatrix Einrichtung | `314` | Foundation/Posting Groups | Geschaeftsbuchungsgruppe, Produktbuchungsgruppe, Warenverkaufskonto, Wareneinkaufskonto und weitere Konto-Spalten | `Neu`, `Liste bearbeiten`, `Weitere Optionen`, `Konten vorschlagen`, `Kopieren...`; TARGET-032E verwirft Page `315` als Kartenroute, weil sie `MwSt.-Posten` zeigt | TARGET-032A/032C/032D/032E: Page 314 sichtbar, Spalten sichtbar, List-New- und Ctrl+Insert-Route blockiert, Page-315-Irrweg verworfen. TARGET-032F parkt die Schreibroute. | Noch keine echte Buchungsmatrix-Karte bewiesen; keine `INLAND`/`WAREN`-Zeile mit `4400`/`5400`, keine Preview, keine Buchung. Naechste Route nur mit neuer Hypothese. |
