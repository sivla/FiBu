...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `PAYMENTS-009`: Apply-/Preview-Readiness im Cash Receipt Journal nicht buchend pruefen; `PAYMENTS-008` zeigt bereits `Journal Check = 0 Issues`, aber Zahlung, OP-Ausgleich und Bankwirkung sind noch nicht erlaubt |
