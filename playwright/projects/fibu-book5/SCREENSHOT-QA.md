...
| `playwright/projects/fibu-book5/img/payments-011-063-bank-account-ledger-payment.png` | rejected Bank-Ledger-Pfad | Der getestete Page-371-Pfad liefert keinen belastbaren Bank Account Ledger Entries Kontext zur Zahlung. | Nicht als Bankpostenbild verwenden. Separaten read-only Bank-Ledger-Folgepfad klaeren. |
