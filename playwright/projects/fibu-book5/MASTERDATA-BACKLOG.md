...
| Anlage | 7, 21 | `FA-CNC-01` | nur geplant; `FIXEDASSETS-001` hat erste Tell-Me-Einstiege read-only geprueft; `FIXEDASSETS-002` hat deutsche Suchbegriffe und den Zielbetrag `120.000 EUR` harmonisiert; `FIXEDASSETS-003` oeffnet Anlagenliste, AfA-Buecher, Einkaufsrechnungen und Anlagenposten direkt als labor-candidate; `FIXEDASSETS-004` zeigt gefiltert: `FA-CNC-01`, `HGB`, `MACHINES` und `K30000` sind nicht sichtbar, Einkaufsrechnungen sind erreichbar; `FIXEDASSETS-005` erreicht `FA Posting Groups` ueber UI und zeigt vorhandene CRONUS-Gruppen, aber nicht `MACHINES` | ja, jetzt `120000` | ja, `fixedassets-001`, `fixedassets-002`, `fixedassets-003`, `fixedassets-004`, `fixedassets-005` | `planned-only / readiness` | P2 | `FIXEDASSETS-006`: vor dem idempotenten UI-Setup-Fit fuer `MACHINES` vorhandene CRONUS-FA-Posting-Group-Konten lesen; danach erst `MACHINES`, Anlage/Kreditor/AfA-Buch und separaten Buchungslauf planen. |
