...
| Order-to-Cash | labor | Sales Orders gesucht, Auftrag per API erzeugt, Kopf/Zeile fotografiert, Dimensionen geprueft, Preview Posting mit Vorschauzeilen, maximierter G/L-Preview-Drilldown und Cleanup nachgewiesen | `playwright/projects/fibu-book5/img/uat-o2c-001-*`, `evidence/uat-o2c-001/` | Klickpfad, EUR, Menge, Lagerort, Preis, Dimension und Posting Preview funktionieren; der fruehere Inventory-Posting-Setup-Blocker ist nicht mehr vorhanden; Steuer bleibt 0 % | deutscher O2C mit 19 % USt, Buchung und Postenspur | Preview-Zeilen und G/L-Preview fachlich erklaeren; danach Steuer-/VAT-Fit oder bewussten Buchungsentscheid vorbereiten |
...
1. G/L-Preview horizontal so scrollen, dass Betragsspalten auch visuell im Screenshot sichtbar sind.
2. Preview-Posting-Zeilen aus `UAT-O2C-001` als Anfaenger-Lernbild erklaeren: Sachposten, Debitorenposten, Artikelposten, detaillierter Debitorenposten und Wertposten.
