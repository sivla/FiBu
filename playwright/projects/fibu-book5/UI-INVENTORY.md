...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `PAYMENTS-007`: Bankkonto `BANK-RM-01` per UI auf `Bank Account Posting Group` und Sachkonto-Fit pruefen/fitten; weiterhin nicht buchen, bis Journal Check danach keine Issues meldet |
