...
| Projektphase | W1 Foundation: Paket-/Feldroute lesend absichern, O2C/P2P weiter gesperrt |
...
| Aktiver Case | `FOUNDATION-SETUP-PACKAGE-FIELD-SELECTION-READFIRST` |
...
| Foundation setup route decisions | active-work: Feldkarte erstellt; Konfigurationspakete sind als realistische Foundation-Setup-Route gewaehlt, aber nicht als Schreibfreigabe. `U-VAT325-DISC` zeigt Table 325 / VAT Posting Setup als Paketmetadatenzeile; naechster Schritt ist ein enger Field-Selection-Readfirst, kein Import/Validate/Apply und kein Setup-Write. |
...
7. Naechster Schritt ist kein O2C/P2P-Beleg, kein Repeat von `VAT-POSTING-SETUP-READFIRST` und kein Setup-Write. Jetzt `FOUNDATION-SETUP-PACKAGE-FIELD-SELECTION-READFIRST` als enges Read-first-Gate vorbereiten/ausfuehren: Feld-/Auswahlkontext sichtbar machen, aber vor jedem Toggle, Import, Validate, Apply oder Setupwert stoppen.
