...
Status: `blocked-safety-gate`, `ui-first`, `setup-fit`, `no-acquire`, `no-preview`, `no-posting`, `not-final`.
...
FA-138 blocked: Posting Group field was not filled to MACHINES.
...
FIXEDASSETS-139: review field-fill blocker.
