...
| Fehlende Dimensionswerte | COMPANY-GROUP.PROD, COMPANY-GROUP.SALES, COMPANY-GROUP.SERVICE, COMPANY-GROUP.SHARED, COMPANY-GROUP.AT, DEPARTMENT.PURCH, DEPARTMENT.WHSE, DEPARTMENT.SERV, DEPARTMENT.FIN, DEPARTMENT.ADMIN, CHANNEL.SHOP, CHANNEL.IC, CHANNEL.SERVICE, CHANNEL.PROJECT, PRODUCTLINE.SPARE, PRODUCTLINE.RENTAL, PRODUCTLINE.SERVICE, LOCATION-GROUP.SIMPLE, LOCATION-GROUP.VAN, LOCATION-GROUP.PROJECT, LOCATION-GROUP.DROP | nicht per API angelegt |
