...
| `MANUFACTURING-001-POSTING` | locked | Verbrauch, Output, Kapazitaet und Kostenposten entstehen | keine aktuelle Freigabe | kontrollierte Fertigungs-/Montagebuchung | Item/Value/Capacity/G/L Entries, Kostenwirkung | `MANUFACTURING-001` Readiness ist erledigt; ohne Freigabe nur Buch-/Evidence-Sync oder anderer read-only Block |
