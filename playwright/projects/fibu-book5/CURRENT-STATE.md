...
- `SERVICE-002` ist als Buch-/Evidence-Sync gelaufen: Kapitel 15 trennt jetzt den fachlichen Zielpfad `SERV-4001` vom aktuellen `RM-DEMO`-Laborstand. Service-Einstiege und `D10000` sind sichtbar; `RM-M100-SN1001`, `SP-PUMP-01`, `RES-TECH` und `VAN-SERV` sind weiter nicht als konkrete Zielobjekte sichtbar. Keine Einrichtung, kein Serviceauftrag, kein Ersatzteilverbrauch, keine Ressourcenerfassung, keine Rechnung und keine Buchung.
