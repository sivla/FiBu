...
| Lagerbestand | Item Journals | 40 | `Post`, Batch Name, Posting Date, Entry Type, Document No., Item No., Location Code, Quantity, Unit Amount, Amount, Unit Cost, `Line` -> `Dimensions`, FactBox `Journal Check`, Zeilenmenue `Weitere Optionen anzeigen` -> `Zeile loeschen` | positiven Trainings-/Opening-Balance-Zugang `RM-M100 +2` kontrolliert vorbereiten und vor Buchung pruefen | `INVENTORY-005`, `INVENTORY-006`, `INVENTORY-007` | `playwright/projects/fibu-book5/img/inventory-005-010-item-journal-direct.png`; `playwright/projects/fibu-book5/img/inventory-006-010-target-journal-line-before-post.png`; `playwright/projects/fibu-book5/img/inventory-007-010-journal-check-no-issues.png`; `playwright/projects/fibu-book5/evidence/inventory-005/`; `playwright/projects/fibu-book5/evidence/inventory-006/`; `playwright/projects/fibu-book5/evidence/inventory-007/` | verstanden als Labor-Preflight: Zielzeile, Unit Cost und `PRODUCTLINE=MACHINE` sichtbar; `Journal Check` zeigt `1 Lines checked`, `0 Lines with issues`, `0 Issues Total`; `Post` sichtbar, keine Preview Posting, keine Buchung, Cleanup erfolgreich | Kapitel 13/23 |
...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `INVENTORY-008`: Nach bewusstem Laborentscheid genau eine positive `RM-M100 +2`-Buchung ausfuehren und Postenspur/Lagerbewertung sichern |
