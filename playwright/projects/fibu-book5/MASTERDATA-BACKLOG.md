...
`WAREHOUSE-002` ist als Buch-/Evidence-Sync erledigt: Kapitel 13 trennt jetzt einfachen Lagerort, Warehouse-Readiness, Gate-Grenze und deutschen Finalnachweis. Ohne Gate-Freigabe keine Bins, keine Lagerort-Aktivierung, keine Warehouse Receipts/Put-aways/Picks/Shipments erzeugen oder buchen. Naechster sicherer Schritt ohne Gate ist `MANUFACTURING-001-READINESS` read-only.
```
