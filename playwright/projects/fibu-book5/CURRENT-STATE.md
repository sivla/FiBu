...
- `MB800-001` ist als Buch-/Readiness-Sync ohne BC-Lauf dokumentiert: Kapitel 34 trennt jetzt MB-800-Lernabdeckung, offizielle Study-Guide-Struktur, vorhandene Labor-Evidence und offene Final-/Gate-Nachweise. Der Lauf hat keine Setup-/Stammdaten-Aenderung und keine Buchung ausgefuehrt. Naechster Schritt ohne Gate ist `LEARNPATH-001-READINESS`.
