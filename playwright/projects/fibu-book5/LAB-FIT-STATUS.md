...
| Inventory | labor | Artikel und Lagerort vorhanden; Verkaufszeile nutzt Lagerort; `FRA-ZL` + `RESALE` wurde mit `Inventory Account = 14140` als CRONUS-Laborfit eingerichtet; `INVENTORY-001` fuehrt O2C und P2P ueber Item Ledger Entries, Value Entries, G/L Entries, Artikelkarten und Location read-only zusammen; `INVENTORY-002` oeffnet `Inventory Valuation` mit Stichtag, Item- und Location-Filter | `masterdata-004`, `masterdata-005`, `masterdata-008`, `masterdata-009`, `UAT-O2C-001`, `p2p-001`, `evidence/inventory-001/INVENTORY-LAB-TRACE.md`, `evidence/inventory-002/INVENTORY-VALUATION-result.json`, `playwright/projects/fibu-book5/img/inventory-001-*`, `playwright/projects/fibu-book5/img/inventory-002-*` | Inventory-Posting-Setup-Luecke ist im Labor geschlossen; O2C-Artikelposten `792` zeigt `RM-M100`, `FRA-ZL`, Menge `-1`; P2P-Artikelposten `793` zeigt `RAW-STEEL`, `FRA-ZL`, Menge `10`; P2P-Sachposten zeigen `22100`/`14140`; Inventory Valuation zeigt `RAW-STEEL = 25.000,00`, `RM-M100 = -42.000,00`, `Total Inventory Value = -17.000,00`; negativer RM-M100-Wert ist Lernfall | Artikelposten, Wertposten, Sachposten und Lagerbewertung in deutscher Zielcompany mit deutschen Konten, Steuerlogik und sauberer Bestandskette | Negativen `RM-M100`-Lagerwert fachlich erklaeren; danach Warehouse separat |
...
2. Inventory-Lernfall vertiefen: `INVENTORY-002` zeigt negative Lagerbewertung fuer `RM-M100`; Ursache aus Bestand vor Verkauf, Kostenkette und Laboraufbau erklaeren; keine Buchung.
