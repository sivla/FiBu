...
| `GATE-W1-GEN-POSTING-SETUP-314-NEW` | Eigenstaendiger `Neu`-Button auf Page 314 | TARGET-032J waehlt `Neu` als naechsten engen Standard-UI-Gate, weil Configuration Packages fuer diesen Blocker zu breit sind | Werte tippen, `Liste bearbeiten`, `Kopieren...`, Konfigurationspaket-Import/Apply, Preview oder Posting | TARGET-032K darf nur den neuen Kontext klassifizieren und per Reopen beweisen, ob eine leere Zeile oder Karte ohne Wertschreibung bestehen bleibt. |
