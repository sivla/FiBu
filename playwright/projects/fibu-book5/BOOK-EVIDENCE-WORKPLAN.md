...
| Anlagen, Projekte, Service, Manufacturing | Weitere Buchkapitel praktisch lernen | Fixed Assets/Warehouse/Manufacturing sind als Readiness bzw. Buch-Sync teilweise belegt; Service und Projects noch nicht gestartet | teilweise belegt | Ohne Gate keine Setup-/Buchungslaeufe; naechster sinnvoller Block ist Service-Readiness read-only. |
