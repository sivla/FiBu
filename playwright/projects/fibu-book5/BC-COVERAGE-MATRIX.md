...
| Manufacturing | Manufacturing | `direct-page-readiness` | `L1`, `L8`, `L9` | Production BOMs, Routings, Work Centers, Released Production Orders | `evidence/manufacturing-001/` bis `evidence/manufacturing-003/` | `img/manufacturing-003-*` | Kapitel 14 | direkte Seitenkontexte belegt; kein Production BOM/Routing fuer `RM-M100`, kein Fertigungsauftrag, kein Verbrauch, kein Output, keine Postenspur | ja | `MANUFACTURING-004` entscheidet Buchdraft-Sync vs. UI-first BOM/Routing-Setup-Readiness |
