...
| Anlage | 7, 21 | `FA-CNC-01` | nur geplant; `FIXEDASSETS-001` hat erste Tell-Me-Einstiege read-only geprueft; `FIXEDASSETS-002` hat deutsche Suchbegriffe und den Zielbetrag `120.000 EUR` harmonisiert; `FIXEDASSETS-003` oeffnet Anlagenliste, AfA-Buecher, Einkaufsrechnungen und Anlagenposten direkt als labor-candidate; `FIXEDASSETS-004` zeigt gefiltert: `FA-CNC-01`, `HGB`, `MACHINES` und `K30000` sind nicht sichtbar, Einkaufsrechnungen sind erreichbar; `FIXEDASSETS-005` erreicht `FA Posting Groups` ueber UI; `FIXEDASSETS-006` liest vorhandene CRONUS-Konten: `EQUIPMENT = 12210/82000`, `GOODWILL = 11300`, `PLANT = 12110/81000`, `PROPERTY = 12130/81000`, `VEHICLES = 12230/82000`; `MACHINES` fehlt weiter | ja, jetzt `120000` | ja, `fixedassets-001`, `fixedassets-002`, `fixedassets-003`, `fixedassets-004`, `fixedassets-005`, `fixedassets-006` | `planned-only / readiness` | P2 | Ohne Gate `FIXEDASSETS-007` read-only: vorhandene AfA-Buecher/Depreciation Books und Anlagenklassen lesen; mit Gate spaeter `MACHINES`, Anlage/Kreditor/AfA-Buch und separaten Buchungslauf planen. |
