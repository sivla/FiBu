...
Auf der Debitorenseite gilt dieselbe Logik, aber mit einem anderen Sammelkonto. Eine Debitorenbuchungsgruppe darf erst angelegt werden, wenn das Forderungskonto sichtbar im Kontenplan vorhanden ist. Das Konto **1406 Abziehbare Vorsteuer 19 Prozent** ist dafuer nicht geeignet, weil es zur Vorsteuer gehoert. Fuer inlaendische Kunden braucht die Universaarl GmbH stattdessen ein eigenes Forderungskonto, zum Beispiel **1400 Forderungen aus Lieferungen und Leistungen**. Solange dieses Konto nicht sichtbar als Bilanzkonto mit Kontoart **Buchung** bestaetigt ist, bleibt die Debitorenbuchungsgruppe gesperrt.
