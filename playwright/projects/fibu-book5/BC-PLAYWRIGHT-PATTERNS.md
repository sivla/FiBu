...
- Nach `FIXEDASSETS-025` ist das Muster fuer leere Karten: zuerst Kartenkontext beweisen, dann aktive Controls vollstaendig mappen, fehlende Controls recovern oder diagnostizieren, dann erst einen separaten Werte-/Lookup- oder Save-Gate-Entscheid treffen.
