...
const TEST_ID = 'fixedassets-291';
const CASE_ID = 'FIXEDASSETS-291-FA-DEPRECIATION-CONTROLLED-OK-AFTER-FA289-NO-POST';
...
test('fixedassets-291 executes Calculate Depreciation OK once after FA-289 and searches journal without post', async ({ page }) => {
  ...
  const result = {
    schemaVersion: 1,
    purpose: 'fixed-assets-depreciation-controlled-ok-after-fa289-no-post',
    caseId: CASE_ID,
    ...
    proved: [
      ...
      ...(allValuesProved
        ? ['HGB, 31.01.2027, FADEP-291-OK and FA-CNC-01 were visibly proven on the request page before OK.']
        : []),
      ...(okExecution.clicked ? ['OK was confirmed exactly once.'] : []),
      ...(journalLineFound ? ['FADEP-291-OK was found in Fixed Asset G/L Journals after OK.'] : ['FADEP-291-OK was not found in Fixed Asset G/L Journals after OK.']),
    ...
    changedFiles: [
      'package.json',
      'playwright/projects/fibu-book5/tests/fixedassets-291-fa-depreciation-controlled-ok-after-fa289-no-post.spec.ts',
      'playwright/projects/fibu-book5/evidence/fixedassets-291/',
    ],
    evidenceRefs: [
      'playwright/projects/fibu-book5/evidence/fixedassets-291/FIXEDASSETS-291-result.json',
      'playwright/projects/fibu-book5/evidence/fixedassets-291/FIXEDASSETS-291-CONTROLLED-OK-NO-POST.md',
      'playwright/projects/fibu-book5/evidence/fixedassets-291/010-ok-execution-result.json',
      'playwright/projects/fibu-book5/evidence/fixedassets-291/020-journal-line-search.json',
    ],
    statePatch: {
      current: {
        activeCase: journalLineFound
          ? 'FIXEDASSETS-292-FA-DEPRECIATION-OK-JOURNAL-LINE-REVIEW'
          : 'FIXEDASSETS-292-FA-DEPRECIATION-OK-RESULT-BLOCKER-REVIEW',
        active_case_file: journalLineFound
          ? '.agent/state/cases/fixedassets-292-fa-depreciation-ok-journal-line-review.json'
          : '.agent/state/cases/fixedassets-292-fa-depreciation-ok-result-blocker-review.json',
        lastReferenceCase: CASE_ID,
        lastReferenceCaseFile: '.agent/state/cases/fixedassets-291-fa-depreciation-controlled-ok-after-fa289-no-post.json',
        nextStep: journalLineFound
          ? 'FIXEDASSETS-292: locally review the FADEP-291-OK journal line and decide whether Preview Posting is now safe.'
          : 'FIXEDASSETS-292: locally review why OK did not produce visible FADEP-291-OK journal evidence before any repeat.',
      },
      coverage: {
        ...
        depreciationReadiness: journalLineFound
          ? 'FA-291 confirmed OK once and found FADEP-291-OK in Fixed Asset G/L Journals. Preview Posting and Post remain locked pending local review.'
          : 'FA-291 confirmed OK once but did not find FADEP-291-OK in Fixed Asset G/L Journals. Repeat OK remains locked pending local review.',
      },
    },
    blockedBy: blocker,
    requiresReview: true,
  ...
  await writeJsonEvidence(faEvidencePath('FIXEDASSETS-291-result.json'), result);
  await writeTextEvidence(
    faEvidencePath('FIXEDASSETS-291-CONTROLLED-OK-NO-POST.md'),
    [
      ...
      `- FADEP-291-OK im Journal sichtbar: ${journalLineFound ? 'ja' : 'nein'}`,
  ...
  await writeTextEvidence(
    ...
    [
      '# FIXEDASSETS-291 Evidence Index',
      '',
      '| Datei | Typ | Beweist | Beweist nicht | Status |',
      '|---|---|---|---|---|',
      '| `FIXEDASSETS-291-result.json` | JSON-Ergebnis | AfA-OK-Ausfuehrung nach FA-289 und Journal-Suchstatus | kein Preview/Post | labor-reference |',
      '| `FIXEDASSETS-291-CONTROLLED-OK-NO-POST.md` | Lernzusammenfassung | OK-Grenze, Ergebnis und naechster Gate-Schritt | keinen deutschen Finalnachweis | labor-reference |',
      ...
      '| `020-journal-line-search.json` | JSON | Journal-Suchbefund fuer `FADEP-291-OK` | keine Buchung | compact |',
