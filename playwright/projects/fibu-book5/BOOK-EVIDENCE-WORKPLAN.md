...
| Bank / Payments | Ausgleich, Zahlung, Bankposten | `PAYMENTS-001` bis `PAYMENTS-010` belegen offene Posten, Cash-Receipt-Draft, `BANK-RM-01`, Journal Check, Apply Entries und Post-Dialog mit Abbruch; `PAYMENTS-011` bucht genau eine UI-first Laborzahlung `PAY011-PS103297`; `PAYMENTS-012` synchronisiert Buch/Evidence; `PAYMENTS-013` belegt Bank Account Ledger Entries ueber Page `372` | Labor belegt fuer Zahlung, OP-Ausgleich, Sachposten und Bankposten; Bankabstimmung offen | `PAYMENTS-014-BANK-LEDGER-BOOK-SYNC`: Kapitel 20, Coverage, Findings und Evidence-Pack mit dem Page-372-Bankpostenpfad abrunden; keine weitere Zahlung und keine Bankabstimmung ohne neues Gate. |
...
Der naechste sichere Schritt ist `PAYMENTS-014-BANK-LEDGER-BOOK-SYNC`.
...
`PAYMENTS-013` ist erledigt. Fuehre als naechstes `PAYMENTS-014-BANK-LEDGER-BOOK-SYNC` durch: Kapitel 20, Coverage, Findings und Evidence-Pack mit dem erfolgreichen Page-372-Bankpostenpfad synchronisieren; keine weitere Zahlung und keine Bankabstimmung ohne neues Gate.
```
