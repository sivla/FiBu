...
1. Aktuellen O2C-Laborbeleg nicht erneut buchen; `REPORTING-002` bis `REPORTING-006` sind erledigt als Sichtbarkeits-/Negativbefunde. Naechster Reporting-Schritt ist ein gezielter UI-Einstieg ueber `Analysis by Dimensions`; ein gezielter Analysis-View-Setup-Fit fuer `PRODUCTLINE`/`CHANNEL` braucht eigene Freigabe.
