...
An dieser Stelle ist die Universaarl GmbH noch nicht buchungsbereit. Ein Lagerort und ein Debitor reichen fuer die Orientierung in Listen und Karten. Fuer echte Belege fehlen aber noch mehrere Grundlagen: Buchungsgruppen, USt-Einrichtung, Artikel- und Lagerbuchung, globale oder Standarddimensionen sowie ein kontrollierter Vorschau- und Buchungspfad. Deshalb wird zuerst die Foundation erneut geprueft, bevor weitere Stammdaten oder Belege angelegt werden.
