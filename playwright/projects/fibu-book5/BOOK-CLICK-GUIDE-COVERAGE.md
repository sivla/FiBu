...
| 2 | O2C | Dimension `PRODUCTLINE = MACHINE` nach Buchung in Posten/Reporting final sichtbar nachweisen | Im O2C-Labor ueber `Line` -> `Related Information` -> `Dimensions` nachgewiesen; in Postenspur noch nicht sichtbar |
