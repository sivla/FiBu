...
2. Nur diese Kernstate-Dateien lesen:
...
3. Danach nur die Skills laden, die fuer den gewaehlten Lauf gebraucht werden.
4. Alte grosse Projektdateien nur gezielt lesen, wenn der State oder ein Skill sie ausdruecklich verlangt.
