...
| `FiBu_Buch_BC_Standardprozesse_DE_Master_Blueprint.md` | ~2.668 | BC-Standardprozesse Deutschland, deutsche BC-Oberfläche, vollständiger Bedien- und Prozesskatalog, Musterkonzern, Rollen, Trainingsdaten, Postenlogik, Lagerlogiken, Admin/Betrieb, Steuerlogiken, Preise, Controlling/GuV, Onboarding, Tipps & Tricks, Standardgrenzen, Extension-Ausblick, Quellen |
