...
1. Dimension `PRODUCTLINE=MACHINE` in gebuchten Posten oder Reporting suchen.
2. Postenspur aus `UAT-O2C-001` als Anfaenger-Lernbild erklaeren: gebuchte Verkaufsrechnung, Debitorenposten, Sachposten, Wertposten und Artikelposten ueber Wertposten-Verknuepfung.
