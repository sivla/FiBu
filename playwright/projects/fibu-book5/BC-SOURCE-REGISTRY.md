...
| Microsoft Learn: Apply company configuration packages | 1 | Configuration Packages, RapidStart, Import/Apply | Einordnung von Konfigurationspaketen als kontrollierter Einrichtungs- und Migrationsweg mit Import/Apply-Logik | Beweis, dass ein konkretes Universaarl-Paket angewendet wurde oder fachlich korrekt ist | Produkt-/Best-Practice-Claim; Universaarl braucht eigenes Paket-, Validierungs- und Reopen-Proof | geprueft 2026-07-05 |
| Microsoft Learn: Set up company configuration packages | 1 | Configuration Packages, Templates, Stammdatenimport | Paket-/Template-Logik fuer Standardwerte und Stammdatenimport | Freigabe fuer unkontrollierte Massenpflege oder Buchclaim ohne Feld-/Tabellenverstaendnis | Produkt-/Best-Practice-Claim; lokale UI-/Importwirkung braucht eigene Evidence | geprueft 2026-07-05 |
| Microsoft Learn: Use Excel to import data with configuration packages | 1 | Excel Import/Export, Configuration Packages | Export nach Excel, Bearbeitung, Import, Validierung und Apply als BC-Standardroute | Ersatz fuer fachliche Feld-/Abhaengigkeitspruefung oder Posting-/Entry-Beweis | Produkt-/Best-Practice-Claim; lokale Ausfuehrung braucht Evidence und Cleanup/Keep-Strategie | geprueft 2026-07-05 |
...
- https://learn.microsoft.com/en-us/dynamics365/business-central/across-import-data-configuration-packages
