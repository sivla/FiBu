...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `PAYMENTS-010`: Zahlungsfreigabecheck/Buchungsdialog-Risiko fuer den Cash-Receipt-Draft klaeren; `PAYMENTS-009` zeigt Apply Entries read-only, aber noch keine Zahlung, keinen OP-Ausgleich und keine Bankwirkung |
