...
Als naechstes gezielt den Payments-Lernblock fortsetzen, ohne erneut O2C/P2P/Inventory zu buchen. Sinnvollster naechster Lauf ist `PAYMENTS-002`: Bankkonto, Payment Journal/Cash Receipt Journal, Zahlungsbedingungen und Apply-Entries-Pfad kontrolliert pruefen. Begruendung: `PAYMENTS-001` beweist jetzt die offenen Ausgangsposten; bevor eine Laborzahlung oder ein OP-Ausgleich erlaubt wird, muss die Bank-/Journal-Readiness dokumentiert sein.
...
8. `PAYMENTS-001` beweist offene Debitoren-/Kreditorenposten als Startpunkt fuer OP-Ausgleich. Offen bleiben Zahlung, Ausgleich, Payment-/Cash-Receipt-Journal, Bankkonto und Bankabstimmung.
