...
- Anlagen: `FIXEDASSETS-001`/`FIXEDASSETS-002` sind nur Labor-Readiness. Praktisch sichtbar sind Tell-Me-/Suchkontexte fuer `Fixed Assets`, `FA Ledger Entries`, `Anlagen`, `AfA`, `Anlagenbuchungsgruppen`, `Einkaufsrechnungen` und `Anlagenposten`. Der alte Testdatenbetrag `250.000` wurde auf das Buchziel `120.000 EUR` harmonisiert. Nicht geprueft sind Anlagenkarte `FA-CNC-01`, AfA-Buch `HGB`, FA Posting Group `MACHINES`, Aktivierung, AfA, Anlagenposten und deutscher Anlagen-Endstand.
