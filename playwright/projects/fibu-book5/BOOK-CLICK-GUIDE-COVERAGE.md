...
| 3 | Inventory / Posting Groups | Bestandskonto fuer `FRA-ZL` + `RESALE` fachlich entscheiden, setzen und erneut `Preview Posting` ausfuehren | Diagnose ist vorhanden; Kontenentscheidung und Folge-Preview sind offen |
