...
- Nach `FIXEDASSETS-024` ist das Muster fuer leere Karten: zuerst Kartenkontext beweisen, dann aktive Controls mappen, dann erst einen separaten Werte-/Lookup- oder Save-Gate-Entscheid treffen.
