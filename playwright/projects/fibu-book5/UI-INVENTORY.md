...
| Payments | Cash Receipt Journals | 255 | Batch Name `GENERAL`, Felder Posting Date, Account Type, Account No., Amount, Aktion `Post`, `Apply Entries`, FactBox Journal Check | Zahlungseingangspfad read-only pruefen | `PAYMENTS-002` | `playwright/projects/fibu-book5/img/payments-002-020-cash-receipt-journal.png`; `evidence/payments-002/` | gesehen/verstanden als Readiness; keine Journalzeile bewusst gefuellt, keine Buchung | Kapitel 19/20 |
...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `PAYMENTS-004`: nicht buchende Zahlungsjournal-Readiness mit `BANK-RM-01`; keine Zahlung buchen, bevor Journalfelder, Gegenkonto, Betrag, Ausgleichsbezug und Preflight passen |
