...
- Active local/live-readfirst case: `FOUNDATION-CONFIGURATION-WORKSHEET-READFIRST`
...
| `.agent/project-template/UNIVERSAARL-CUSTOMER-PROJECT-DATA-PACKAGES-DRAFT.md` | `active-work` | Customer-project-like Universaarl data packages are Jira-ready, not BC-setup-ready. |
