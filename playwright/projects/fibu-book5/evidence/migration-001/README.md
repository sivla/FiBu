...
Ohne Gate bleibt es bei Buch-/Readiness-Arbeit. Praktische Migration, Configuration Packages, neue Company, Import und Opening-Balance-Buchung brauchen einen eigenen freigegebenen Lauf. `INTEGRATIONS-001` und `OPERATIONS-001` haben die naechsten sicheren Syncs inzwischen erledigt; ohne Gate ist jetzt `SOLUTIONARCHITECT-001-READINESS` der naechste Handover-Block.
