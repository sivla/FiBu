...
| Entscheidung | Kapitel 40 trennt Quellen, Labor-Evidence und deutschen Finalnachweis. `Q10` Shopify bleibt nur Out-of-Scope-Marker. `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `REPORTING-013-ANALYSIS-VIEW-FIELDMAPPING-SETUP`. |
...
| Entscheidung | Kapitel 39 trennt Templates, Handover und echte Evidence. `SOURCES-001`, `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `REPORTING-013-ANALYSIS-VIEW-FIELDMAPPING-SETUP`. |
...
| Entscheidung | Kapitel 38 trennt jetzt Index, Zielpfad, QA-Rahmen, echte Klickpfad-Evidence, Labor-Nachweis und offenen deutschen Finalnachweis. `SOURCES-001`, `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `REPORTING-013-ANALYSIS-VIEW-FIELDMAPPING-SETUP`. |
...
| Status | offen |
| Projekt | fibu-book5 |
| Testfall | `REPORTING-002`, `REPORTING-003`, `REPORTING-004`, `REPORTING-005`, `REPORTING-006`, `REPORTING-007`, `REPORTING-008`, `REPORTING-009`, `GOVERNANCE-006`, `REPORTING-011`, `REPORTING-012`, `GOVERNANCE-007` |
