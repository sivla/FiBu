...
- `SERVICE-001` als read-only Evidence fuer Kapitel 15: Service-Einstiege sichtbar, Zielobjekte fuer den Buchfall noch nicht tragfaehig belegt
...
- `SERVICE-001` ist als read-only Service-Readiness gelaufen: Service-Einstiege sind sichtbar, `D10000` ist sichtbar, aber `RM-M100-SN1001`, `SP-PUMP-01`, `RES-TECH` und `VAN-SERV` sind als konkrete Zielobjekte im Labor nicht sichtbar. Der Lauf hat keine Einrichtung geaendert, keinen Serviceauftrag angelegt, kein Ersatzteil verbraucht, keine Ressource erfasst, keine Rechnung erzeugt und nichts gebucht.
