...
| Reihenfolge | Ziel |
|---:|---|
| 1 | `PAYMENTS-008`: Amount-Feld, Amount-LCY-Anzeige und Spaltenposition im Cash Receipt Journal nach `BANK-RM-01 = CHECKING` klaeren; weiterhin nicht buchen, bis Journal Check keine Issues meldet |
