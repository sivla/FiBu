# FiBu – Projektkontext für Claude
...
| `FiBu_Buch_BC_Standardprozesse_DE_Master_Blueprint.md` | ~6.438 | BC-Standardprozesse Deutschland als sauber fortlaufend nummeriertes sechsteiliges Einführungs-, Schulungs-, Praxis- und Architekturhandbuch; ERP-Einsteigergrundlagen, Rhein-Main-Fallstudie, deutsche BC-Oberfläche, konkrete Bedienpfade, Buchungsspur, Fehlerdiagnose, UAT, Übungslösungen, MB-800-Kompetenzmatrix, Microsoft-Learn-Lernpfad-Mapping, Solution-Architect-Pfad, Greenfield-Einrichtung, Projektartefakte, Dokumente/E-Mail, Genehmigungen/SoD, Datenqualität/Migration, Monitoring/Hypercare, wiederkehrende Finance-Prozesse, Postenlogik, Lagerlogiken, Admin/Betrieb, Steuerlogiken, Preise, Controlling/GuV, Tipps & Tricks, Standardgrenzen, Extension-Ausblick, Quellen |
...
- MB-800-Kompetenzmatrix und Microsoft-Learn-Lernpfad-Mapping als Prüfungs- und Vollständigkeitsnachweis
- Business-Central-Solution-Architect-Pfad, Architekturentscheidungen und Projektartefakt-Templates
