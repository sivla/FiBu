...
| No. Series / Nummernserien | `456` | Foundation/Numbering | Seriencode, Beschreibung, Start-/Endnummernspalten, Checkboxen wie `Standardnr.`, `Manuelle Anz.` und `Luecken in Nummern zulassen` | `Zeilen`, `Liste bearbeiten`, Page-Inspection-Shortcut `Ctrl+Alt+F1`; Checkbox-Klicks nur mit gesicherter Zeilenbindung | `evidence/target-016*/`; TARGET-016 zeigt U-Serienkoepfe, TARGET-016D beweist Lines-Page/Table/Felder; TARGET-036D2 zeigt `U-VEND` mit sichtbaren Checkbox-Spalten | TARGET-036D2: Der sichtbare row-scoped Klick auf `Standardnr.` fuer `U-VEND` persistiert nicht und driftet visuell aus dem sicheren Fokus. Nicht wiederholen ohne neue Route. Keine Stammdaten-/Belegnummernreife. |
