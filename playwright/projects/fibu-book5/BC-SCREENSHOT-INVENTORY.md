...
| Screenshot | Page | Company | Schritt | Was sieht man? | Interner Beweis | Beweist nicht | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `target-031-010-chart-of-accounts-receivables-check.png` | Kontenplan, Page 16 | `playthru` / `UNIVERSAARL-DE` | Read-only Forderungskonto-Pruefung | Sichtbar sind `1200`, `1406`, `1800`, `3300`, `3806`, `4400`, `5400`; `1400 Forderungen aus Lieferungen und Leistungen` ist nicht sichtbar | Der aktuelle Kontenplan reicht nicht fuer eine Debitorenbuchungsgruppen-Schreibung auf `1400` | kein 1400-Reopen-Proof, keine Debitorenbuchungsgruppe, keine Forderungsposten | `blocked-prerequisite`, `screenshot-qa-reviewed` |
...
Screenshot-QA zu TARGET-031: Der Lauf verhindert einen fachlichen Fehler. `1406` ist als Vorsteuerkonto sichtbar, darf aber nicht als Debitorensammelkonto verwendet werden. Weil `1400 Forderungen aus Lieferungen und Leistungen` nicht sichtbar bewiesen ist, bleibt die Debitorenbuchungsgruppe gesperrt. Der naechste Schritt ist ein enger 1400-Sachkonto-Recovery-Case mit Reopen-Proof.
