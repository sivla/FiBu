...
Als naechstes gezielt den Payments-Lernblock fortsetzen, ohne erneut O2C/P2P/Inventory zu buchen. Sinnvollster naechster Lauf ist `PAYMENTS-004` als kontrollierte, nicht buchende Zahlungsjournal-Readiness: eine einzelne Journalzeile fachlich vorbereiten oder mindestens die Pflichtfelder pruefen, aber weiterhin keine Zahlung buchen, keinen Ausgleich setzen und keine Bankabstimmung starten. Begruendung: `PAYMENTS-001` beweist die offenen Ausgangsposten, `PAYMENTS-002` beweist Journal-/Apply-Pfade, und `PAYMENTS-003` beweist das Laborbankkonto `BANK-RM-01`; offen ist jetzt der konkrete Journal-/Ausgleichsfit.
...
8. `PAYMENTS-001` beweist offene Debitoren-/Kreditorenposten als Startpunkt fuer OP-Ausgleich. `PAYMENTS-002` beweist Bankkonten-, Cash-Receipt-Journal-, Payment-Journal- und Apply-Entries-Readiness. `PAYMENTS-003` beweist `BANK-RM-01` als neues CRONUS-USA-Laborbankkonto. Offen bleiben Zahlungsjournalzeile, Zahlung, Ausgleich, Bank Account Posting Group/Sachkonto-Fit und Bankabstimmung.
