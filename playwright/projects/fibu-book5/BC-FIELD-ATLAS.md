...
| `Location Code` | P2P | Purchase Order `106051`, RAW-STEEL-Zeile | Lagerort waere Konten-/Lagerortsteuerung fuer Teil-WE | `evidence/p2p-008/P2P-008-result.json` | `FRA-ZL` nicht sichtbar gespeichert; Zeile zeigt weiter `ATLANTA, GA` |
| `Quantity` | P2P | Purchase Order `106051`, RAW-STEEL-Zeile | Bestellmenge fuer Teil-WE | `evidence/p2p-008/P2P-008-result.json` | Menge `4` nicht sichtbar bestaetigt |
| `Direct Unit Cost Excl. Tax` | P2P | Purchase Order `106051`, RAW-STEEL-Zeile | Preis-/Wertbasis fuer Lager-/Sachposten | `evidence/p2p-008/P2P-008-result.json` | `2.500,00` sichtbar, aber nicht als neu gesetzter Wert bewiesen |
