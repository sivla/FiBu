...
Ohne Gate-Freigabe starte `FIXEDASSETS-008` als Buch-/Checklisten-Sync: Kapitel 21 und die Anlagen-Setup-Reihenfolge mit `FIXEDASSETS-005` bis `FIXEDASSETS-007` abgleichen. Keine BC-Ausfuehrung, keine Anlagenbuchungsgruppe anlegen oder aendern, kein AfA-Buch anlegen oder aendern, keine Anlagenkarte, keine Einkaufsrechnung, keine Anlagenbuchung.
```
