...
Im Kontenplan sieht man bei jedem Sachkonto die Nummer, den Namen, `GuV/Bilanz` und die Kontoart. `1800 Bank Saarland` steht als Bilanzkonto fuer spaetere Bank- und Zahlungsprozesse. `1406 Abziehbare Vorsteuer 19 Prozent` steht ebenfalls als Bilanzkonto und wird spaeter fuer die Einkaufs-USt gebraucht. Das Konto allein bucht aber noch keine Vorsteuer. Erst wenn VAT Business Posting Groups, VAT Product Posting Groups und VAT Posting Setup zusammenpassen, kann Business Central beim Einkauf automatisch Vorsteuerposten erzeugen.
