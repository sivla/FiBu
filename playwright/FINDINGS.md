...
| Entscheidung | Kapitel 40 trennt Quellen, Labor-Evidence und deutschen Finalnachweis. `Q10` Shopify bleibt nur Out-of-Scope-Marker. `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `GOVERNANCE-007-REPORTING-NEXT-GATE-DECISION`. |
...
| Entscheidung | Kapitel 39 trennt Templates, Handover und echte Evidence. `SOURCES-001`, `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `GOVERNANCE-007-REPORTING-NEXT-GATE-DECISION`. |
...
| Entscheidung | Kapitel 38 trennt jetzt Index, Zielpfad, QA-Rahmen, echte Klickpfad-Evidence, Labor-Nachweis und offenen deutschen Finalnachweis. `SOURCES-001`, `PAYMENTS-012`, `REPORTING-011` und `REPORTING-012` sind inzwischen erledigt; naechster sicherer Block ist `GOVERNANCE-007-REPORTING-NEXT-GATE-DECISION`. |
