...
| No. Series Lines / Nr.-Serienzeilen | `457` | Foundation/Numbering | Tabelle `No. Series Line (309)` mit `Starting Date`, `Starting No.`, `Ending No.`, `Warning No.`, `Increment-by No.`, `Last No. Used`, `Open` | `Liste bearbeiten`; Page Inspection; `Einstellungen > Personalisieren`; `Fertig` zum Verlassen ohne Aenderung | TARGET-016D: `target-016d-040-after-page-inspection-shortcut.png`; TARGET-016E: Feldfluss/F2-Rejected-Proofs; TARGET-016F: `target-016f-030-personalize-mode-or-menu.png` | Koordinaten-, Selected-Cell-, einfacher Feldfluss- und F2-Routen nicht wiederholen; Personalisieren ist nur UI-/Feldkartenpfad, noch keine Wertpersistenz |
