...
| Manufacturing | Manufacturing | `bookmaster-synced-labor` | `L1`, `L8`, `L9` | Production BOMs, Routings, Work Centers, Released Production Orders | `evidence/manufacturing-001/` bis `evidence/manufacturing-005/`, `book-drafts/manufacturing-labor-draft.md` | `img/manufacturing-003-*` | Kapitel 14 | direkte Seitenkontexte und Buchmaster-Laborblock belegt; kein Production BOM/Routing fuer `RM-M100`, kein Fertigungsauftrag, kein Verbrauch, kein Output, keine Postenspur | ja | `MANUFACTURING-006` Production-BOM-/Routing-Setup-Readiness entscheiden |
